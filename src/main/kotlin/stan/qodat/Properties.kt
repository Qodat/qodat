...
object Properties {
    ...
    val selectedNpcId = SimpleStringProperty()
    val selectedItemId = SimpleStringProperty()
    val selectedObjectId = SimpleStringProperty()
    val selectedSpriteId = SimpleStringProperty()
    val selectedSpotAnimId = SimpleStringProperty()
    val selectedAnimationId = SimpleStringProperty()
    val selectedInterfaceId = SimpleStringProperty()
    ...
    fun bind(sessionManager: PropertiesManager) {
        ...
        sessionManager.bindString("last-selected-npc-id", selectedNpcId)
        sessionManager.bindString("last-selected-item-id", selectedItemId)
        sessionManager.bindString("last-selected-object-id", selectedObjectId)
        sessionManager.bindString("last-selected-spot-anim-id", selectedSpotAnimId)
        sessionManager.bindString("last-selected-animation-id", selectedAnimationId)
